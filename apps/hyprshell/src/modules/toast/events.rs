...
fn charging() {
    use crate::shared::services::battery::{self, Battery};
    on_change(
        battery::subscribe,
...
fn game_mode() {
    use crate::shared::services::gamemode::{self, GameMode};
    on_change(
        gamemode::subscribe,
...
fn dnd() {
    use crate::shared::services::notifications::{self, SharedSnapshot};
...
fn audio() {
    use crate::shared::services::pipewire::{self, Graph};
    ...
    watch(pipewire::subscribe, move |graph: Graph| {
        ...
        let (output, input) = crate::core::shell::config()
...
fn keyboard_layout() {
    use crate::shared::services::hyprland::{self, KeyboardLayout};
    on_change(
...
fn vpn() {
    use crate::shared::services::vpn::{self, Vpn};

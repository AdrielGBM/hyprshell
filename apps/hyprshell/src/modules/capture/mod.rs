...
use crate::shared::services::recorder::{self, Scope};
use crate::shared::services::screenshot::{self, Request, Target};
...
pub fn screenshot_output() {
    let target = match crate::core::shell::focused_output() {
...
pub fn record_output() {
    let scope = match crate::core::shell::focused_output() {

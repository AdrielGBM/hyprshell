...
use crate::core::config::RecorderConfig;
use crate::shared::services::broadcast::Store;
use crate::shared::services::screenshot::Area;
...
fn toast(title: &str, body: &str) {
    ...
    crate::shared::services::toaster::post(
        crate::shared::services::toaster::Event::Recording,
        crate::shared::glyph::recording(state.active),
        title.to_string(),
        body.to_string(),
    );
}
